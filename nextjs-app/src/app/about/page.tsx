              ...
              <SimpleGrid columns={{ base: 1, md: 3 }} gap={8}>
                <Box>
                  ...
                  <VStack gap={3} align="start">
                    <Box color={textColor} display="flex" alignItems="center" gap={2}>
                    ...
                    <Box color={textColor} display="flex" alignItems="center" gap={2}>
                      <Icon as={CheckCircleIcon} color="green.400" />
                      Výcvik v <a href='https://www.psychoterapie-integrace.cz/vycvik/popis-vycviku-VIP4' target='_blank' rel='noopener noreferrer' style={{ color: 'green.500' }}>integrativní psychoterapii</a>
                    </Box>
                  </VStack>
                </Box>
                <Box>
                  ...
                  <VStack gap={3} align="start">
                    <Box color={textColor} display="flex" alignItems="center" gap={2}>
                      <Icon as={CheckCircleIcon} color="green.400" />
                      Certifikovaný psychoterapeut – 1010 hodin výcviku <a href='src/ext/Certifikat.pdf' target='_blank' rel='noopener noreferrer' style={{ color: 'green.400' }}>(Certifikát)</a>
                    </Box>
                    <Box color={textColor} display="flex" alignItems="center" gap={2}>
                      <Icon as={CheckCircleIcon} color="green.400" />
                      Certifikovaný kouč
                    ...
                    <Box color={textColor} display="flex" alignItems="center" gap={2}>
                      <Icon as={CheckCircleIcon} color="green.400" />
                      Člen profesionální psychoterapeutické asociace <a href="https://czap.cz/" target="_blank" rel="noopener noreferrer" style={{ color: 'green.400' }}>(ČAP)</a>
                    </Box>
                  </VStack>
                </Box>
                <Box>
